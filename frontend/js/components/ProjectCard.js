function ProjectCard({ project, index }) {
  return (
    <div className="project-card reveal" style={{ '--card-accent': project.accent, animationDelay: `${index * 0.1}s` }}>
      ...
      <p className="project-problem">
        ...
        <span style={{display:'block', marginTop:8}}><strong>Solution: </strong>{project.solution}</span>
      </p>
